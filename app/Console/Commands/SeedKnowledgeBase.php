...
class SeedKnowledgeBase extends Command
{
    ...
    public function handle(EmbeddingService $embeddingService, VectorDatabaseService $vectorDb)
    {
        ...
        $documents = [
            [
                'id' => 'pasal-57',
                'metadata' => ['pasal' => 'Pasal 57', 'topic' => 'Helm', 'topik' => 'Helm', 'source' => 'UU No. 22 Tahun 2009', 'title' => 'Kewajiban Helm SNI'],
            ...
            [
                'id' => 'pasal-281',
                'metadata' => ['pasal' => 'Pasal 281', 'topic' => 'SIM', 'topik' => 'SIM', 'source' => 'UU No. 22 Tahun 2009', 'title' => 'Kewajiban Memiliki SIM'],
            ...
            [
                'id' => 'pasal-288',
                'metadata' => ['pasal' => 'Pasal 288', 'topic' => 'STNK', 'topik' => 'STNK', 'source' => 'UU No. 22 Tahun 2009', 'title' => 'Kewajiban Membawa STNK'],
            ...
            [
                'id' => 'pasal-287',
                'metadata' => ['pasal' => 'Pasal 287', 'topic' => 'Rambu dan Lampu Lalu Lintas', 'topik' => 'Rambu dan Lampu Lalu Lintas', 'source' => 'UU No. 22 Tahun 2009', 'title' => 'Pelanggaran Rambu dan Lampu Lalu Lintas'],
